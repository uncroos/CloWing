...
class OotdFashionScreen extends StatefulWidget {
  @override
  _OotdFashionScreenState createState() => _OotdFashionScreenState();
}

class _OotdFashionScreenState extends State<OotdFashionScreen> {
